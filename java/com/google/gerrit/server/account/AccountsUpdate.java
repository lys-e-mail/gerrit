 ...
 * updated.
 *
 * <p>Updates can be batched ö BatchRefUpdate to one account are always atomic.
 *
...
public class AccountsUpdate {
  ...
  public Optional<AccountState> update( // ö update() should really also take UpdateArguments
  ...
  private ExecutableUpdate createExecutableUpdate(UpdateArguments updateArguments) {
    return repo -> {
      ...
      return new UpdatedAccount(
          updateArguments.message, accountConfig, extIdNotes, cachedDefaultPreferences, false);
    };
  }

  /** ö Document e.g. error handling*/

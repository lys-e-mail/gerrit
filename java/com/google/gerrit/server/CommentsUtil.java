...
<<<<<<< HEAD   (83893d Merge "Add uniqueTag to the Account class.")
...
>>>>>>> BRANCH (ceca5b Merge branch 'stable-3.8' into stable-3.9)
...
>>>>>>> BRANCH (ceca5b Merge branch 'stable-3.8' into stable-3.9)
  ...
  public List<HumanComment> draftByChangeFileAuthor(
    ...
    return commentsOnFile(notes.load().getDraftComments(author, getVirtualId(notes)), file);
  }

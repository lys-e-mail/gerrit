...
import static com.google.gerrit.proto.Entities.EmailTask.EmailHeader.EmailHeaderName.FROM_ID;
import static com.google.gerrit.proto.Entities.EmailTask.EmailHeader.EmailHeaderName.MESSAGE_ID;
import static com.google.gerrit.proto.Entities.EmailTask.EmailHeader.EmailHeaderName.TIMESTAMP;
...
import com.google.gerrit.proto.Entities.EmailTask.EmailEventType;
import com.google.gerrit.proto.Entities.EmailTask.EmailHeader;
import com.google.gerrit.proto.Entities.EmailTask.EmailHeader.EmailHeaderName;
...
public class AbandonOp implements BatchUpdateOp {
  ...
  private final InMemoryEmailTaskDispatcher emailTaskDispatcher;
  ...
  AbandonOp(
      ...
      InMemoryEmailTaskDispatcher emailDispatcher,
  ...
  public void postUpdate(PostUpdateContext ctx) throws IOException {
    ...
    EmailTask.Builder emailTaskBuilder =
        EmailTask.newBuilder()
            .setEventType(EmailEventType.ABANDON)
  ...
  private EmailHeader header(EmailHeaderName headerName, String value) {
    return EmailHeader.newBuilder().setName(headerName).setValue(value).build();
  }

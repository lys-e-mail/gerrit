...
import com.google.gerrit.server.restapi.config.CleanChanges.Input;
...
@Singleton
public class CleanChanges implements RestModifyView<ConfigResource, Input> {
  ...
  @Inject
  CleanChanges(WorkQueue workQueue, ChangeCleanupRunner.Factory runnerFactory) {

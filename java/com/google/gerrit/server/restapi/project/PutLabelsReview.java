...
public class PutLabelsReview implements RestModifyView<ProjectResource, BatchLabelInput> {

  private final RepoMetaDataUpdater repoMetaDataUpdater;
  private final PostLabels postLabels;

  @Inject
  PutLabelsReview(RepoMetaDataUpdater repoMetaDataUpdater, PostLabels postLabels) {

...
public abstract class AbstractPostCollection<TId, TResource extends RestResource, TItemInput>
    implements RestCollectionModifyView<
        ProjectResource, TResource, AbstractBatchInput<TItemInput>> {
  ...
  @Override
  public Response<?> apply(ProjectResource rsrc, AbstractBatchInput<TItemInput> input)
    ...
    try (var configUpdater =
        updater.updateConfig(rsrc.getNameKey(), input.commitMessage, defaultCommitMessage())) {

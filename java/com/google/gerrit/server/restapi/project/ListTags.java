...
public class ListTags implements RestReadView<ProjectResource> {
  ...
  @Option(name = "--sort_by", aliases = {"-sortby"}, usage = "sort the tags")
  ...
  private ListTagSortOption sortBy;

  @Inject
  public ListTags(
      GitRepositoryManager repoManager, PermissionBackend permissionBackend, WebLinks webLinks, TagSorter tagSorter) {

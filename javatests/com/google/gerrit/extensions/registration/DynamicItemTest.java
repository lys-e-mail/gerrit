...
public class DynamicItemTest {
  ...
  public static final String UNEXPECTED_PLUGIN_NAME = "unexpected-plugin";
  public static final String DYNAMIC_ITEM_1 = "item-1";
  public static final String DYNAMIC_ITEM_2 = "item-2";
  public static final TypeLiteral<String> STRING_TYPE_LITERAL = new TypeLiteral<>() {};
  public static final TypeLiteral<FinalItemApi> FINAL_ITEM_API_TYPE_LITERAL =
      new TypeLiteral<>() {};
  public static final TypeLiteral<FinalItemApiForPlugin> FINAL_TARGET_PLUGIN_ITEM_API_TYPE_LITERAL =
      new TypeLiteral<>() {};

  @DynamicItem.Final
  public static interface FinalItemApi {
    String name();
  }

  public static class FinalItemImpl implements FinalItemApi {
    public static FinalItemApi INSTANCE = new FinalItemImpl();

    @Override
    public String name() {
      return FinalItemImpl.class.getName();
    }
  }

  @DynamicItem.Final(implementedByPlugin = PLUGIN_NAME)
  public static interface FinalItemApiForPlugin {
    String name();
  }

  public static class FinalItemImplByPlugin implements FinalItemApiForPlugin {
    public static FinalItemApiForPlugin INSTANCE = new FinalItemImplByPlugin();

    @Override
    public String name() {
      return FinalItemImplByPlugin.class.getName();
    }
  }

...
public class TagsIT extends AbstractDaemonTest {
  ...
  public void listTags() throws Exception {
    ...
    result = getTags().withDescendingOrder(true).withLimit(2).withSortBy(ListTagSortOption.CREATION_TIME).get();
  ...
  private void createTags() throws Exception {
    ...
    for (String tagname : Lists.reverse(testTags)) {
      input.message = tagname; // This updated the 'created' time of the tag

...
public class LabelsReviewIT extends AbstractDaemonTest {
  ...
  public void createLabelsChangeWithDefaultMessage() throws Exception {
    ...
    RestResponse rep =
        adminRestSession.put("/projects/" + defaultMessageProject.get() + "/labels:review", input);
    rep.assertCreated();
    ...
    assertThat(config.getStringList("label", "Foo", "value"))
        .asList().containsExactly("+1 Looks Good", "0 Don't Know", "-1 Looks Bad");
  }
  ...
  public void createLabelsChangeWithCustomMessage() throws Exception {
    ...
    RestResponse rep =
        adminRestSession.put("/projects/" + customMessageProject.get() + "/labels:review", input);
    rep.assertCreated();

...
export class GrTextarea extends LitElement {
   ...
   * http://google3/third_party/javascript/lit/packages/lit-html/src/internal-security.ts;l=34;rcl=558886107
   */
  @property({type: String})
  set value(newValue) {
  ...
  private toggleHintVisibilityIfAny() {
  ...
  private getSelection(): Selection | undefined | null {
    // TODO(b/318810392): Add support for Safari.
...
declare global {
  ...
  interface HTMLElementEventMap {
    ...
    // prettier-ignore
    'hintApplied': CustomEvent<{}>;
    // prettier-ignore
    'hintShown': CustomEvent<{}>;
    // prettier-ignore
    'hintDismissed': CustomEvent<{}>;
    // prettier-ignore
    'cursorPositionChange': CustomEvent<{}>;
  }
}
